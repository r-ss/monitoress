...
class ProbeManager:
    ...
    def __init__(self):
        ...
        self.add_entity(EntityAPI("selenium_playground", interval=380 * 60, url="http://foldwrap.com:8666/info", look_for="resource", expected="selenium-playground", schema=SeleniumBM, extrafields=["last_run", "last_count"]))
