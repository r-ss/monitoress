...
class ProbeManager:
    ...
    def __init__(self):
        ...
        self.add_entity(EntityAPI("torrent-downloader", interval=380 * 60, url="http://foldwrap.com:8666/info", look_for="resource", expected="torrent-downloader", schema=TorrentDownloaderBM, extrafields=["last_run", "last_count"]))
